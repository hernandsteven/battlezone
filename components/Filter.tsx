      ...
      return (
        <div className="flex flex-row gap-2">
          {platforms.map((platform, idx) => (
            ...
            >
              <h1 className="text-md font-semibold">{platform}</h1>
            </div>
          ))}
        </div>
      );
        ...
        <>
          <div className="flex flex-row border-b border-tertiary h-32 bg-secondary text-xl min-h-fit">
            ...
            >
              ...
              <motion.div
                animate={{
                  rotate: isClicked && filter === "game" ? -180 : 0,
                }}
                transition={{
                  duration: 0.3,
                }}
              >
                <BsArrowDownShort
                  className={`flex flex-1 text-3xl ${
                    isClicked && filter === "game" ? "bg-quaternary" : ""
                  } rounded-full`}
                />
              </motion.div>
            </div>
            ...
            >
              ...
              <motion.div
                animate={{
                  rotate: isClicked && filter === "region" ? -180 : 0,
                }}
                transition={{
                  duration: 0.3,
                }}
              >
                <BsArrowDownShort
                  className={`flex flex-1 text-3xl ${
                    isClicked && filter === "region" ? "bg-quaternary" : ""
                  } rounded-full`}
                />
              </motion.div>
            </div>
            ...
            >
              ...
              <motion.div
                animate={{
                  rotate: isClicked && filter === "platform" ? -180 : 0,
                }}
                transition={{
                  duration: 0.3,
                }}
              >
                <BsArrowDownShort
                  className={`flex flex-1 text-3xl ${
                    isClicked && filter === "platform" ? "bg-quaternary" : ""
                  } rounded-full`}
                />
              </motion.div>
            </div>
